...
var get = function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                users = _a.sent();
                res.status(200).json({ message: 'OK', data: { users: users } });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                res.status(500).json({ message: 'not ok', data: { error: error_1 } });
                return [3 /*break*/, 3];
...
var post = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                res.status(500).json({ message: 'not ok', data: { error: error_2 } });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var getById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                res.status(500).json({ message: 'not ok', data: { error: error_3 } });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var uploadFile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var params, files, file, avatar, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                params = req.params, files = req.files;
                if (!(!files && !params.id)) return [3 /*break*/, 1];
            ...
            case 1:
                ...
                file = void 0;
                if (files) {
                    file = (0, lodash_1.isArray)(files.avatar) ? files.avatar[0] : files.avatar;
                }
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, user_1.default.updateAvatar(file, params.id)];
            case 3:
                avatar = _a.sent();
                res.status(201).json({
